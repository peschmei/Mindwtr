...
tasks, notes, and projects stay on your device. The few things that touch the
network - sync to your chosen provider, anonymous usage analytics with an
opt-out, in-app feedback, and optional bring-your-own-key AI - only happen when
you opt in.
