...
export const projectsScreenStyles = StyleSheet.create({
    ...
    projectMetadataRowDivider: {
        borderTopWidth: StyleSheet.hairlineWidth,
        marginTop: 8,
        paddingTop: 8,
    },
    projectMetadataControls: {
        flex: 1,
        minWidth: 0,
        flexDirection: 'row',
        alignItems: 'center',
    ...
    projectMetadataValueText: {
        fontSize: 13,
        fontWeight: '600',
    },
    projectMetadataClearButton: {
        width: 32,
        height: 32,
        alignItems: 'center',
        justifyContent: 'center',
