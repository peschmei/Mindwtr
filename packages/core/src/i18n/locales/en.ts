...
export const en: Record<string, string> = {
        ...
        'settings.feedbackPrivacy': 'This sends your message, optional email, app version, platform, and any diagnostics you choose to include. Task content is not attached.',
