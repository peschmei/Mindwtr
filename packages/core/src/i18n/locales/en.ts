...
export const en: Record<string, string> = {
        ...
        'settings.analyticsHeartbeatDesc': 'Sends anonymous diagnostics: app version, platform, install channel, OS, device class, locale, and app-generated random ID. No task text, notes, or personal data.',
        'settings.analyticsHeartbeatDisableTitle': 'Turn off diagnostics?',
        'settings.analyticsHeartbeatDisableDesc': 'Diagnostics never include task text, notes, user data, or personal info. They help developers understand which platforms and versions need support.',
