...
export const deOverrides: Record<string, string> = {
        ...
        'settings.analyticsHeartbeatDesc': 'Sendet anonyme Diagnosedaten: App-Version, Plattform, Installationskanal, Betriebssystem, Geräteklasse, Locale und eine von der App erzeugte zufällige ID. Keine Aufgabentexte, Notizen oder personenbezogenen Daten.',
        'settings.analyticsHeartbeatDisableTitle': 'Diagnostik ausschalten?',
        'settings.analyticsHeartbeatDisableDesc': 'Diagnosedaten enthalten nie Aufgabentexte, Notizen, Nutzerdaten oder persönliche Infos. Sie helfen Entwicklern zu verstehen, welche Plattformen und Versionen Unterstützung brauchen.',
