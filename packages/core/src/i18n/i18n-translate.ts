...
const csPairs: Array<[string, string]> = [
        ['Settings', 'Nastavení'],
        ['General', 'Obecné'],
        ['Appearance', 'Vzhled'],
        ['Language', 'Jazyk'],
        ...
        ['Error', 'Chyba'],
        ['Notice', 'Upozornění'],
        ['Update Available', 'Aktualizace dostupná'],
        ['Up to Date', 'Aktuální'],
        ...
        ['Never', 'Nikdy'],
        ['Conflicts', 'Konflikty'],
        ['No free time', 'Žádný volný čas'],
        ['Time conflict', 'Časový konflikt'],
        ['days', 'dní'],
    ];
...
const itPairs: Array<[string, string]> = [
        ...
        ['Optional', 'Opzionale'],
        ['Test', 'Test'],
        ['Last Sync', 'Ultima sinc.'],
        ['Never', 'Mai'],
        ['Conflicts', 'Conflitti'],
        ['No free time', 'Nessuno slot libero'],
        ['Time conflict', 'Conflitto di orario'],
        ['days', 'giorni'],
    ];
...
const viPairs: Array<[string, string]> = [
        ['Settings', 'Cài đặt'],
        ['General', 'Chung'],
        ...
        ['Next', 'Tiếp theo'],
        ['Waiting', 'Đang chờ'],
        ['Someday/Maybe', 'Tương lai/Có thể'],
        ['Calendar', 'Lịch'],
        ['Review', 'Xem lại'],
        ['Archive', 'Lưu trữ'],
        ['Archived', 'Đã lưu trữ'],
        ...
        ['Never', 'Không bao giờ'],
        ['Conflicts', 'Xung đột'],
        ['No free time', 'Không còn thời gian trống'],
        ['Time conflict', 'Trùng thời gian'],
        ['days', 'ngày'],
];
